...
contract BlindAuction {
    ...
    /// place multiple bids.
    function bid(bytes32 _blindedBid) // 암호화된 입찰가 값이다.
        public
        payable
        ...
        onlyBefore(revealEnd)
    {
        ...
        require(_values.length == length, "입찰 참가자가 아닙니다.");
        require(_fake.length == length, "fake 값이 없습니다.");
        require(_secret.length == length, "secret 값이 없습니다.");
